...
public struct Tensor: Equatable, Hashable {
    ...
    /// The data of the `Tensor`. The data is created with copied memory content.
    ...
    ///   - quantizationParameters: Parameters for the `Tensor` if using a quantized model. The default is `nil`.
    init(
        name: String,
        dataType: DataType,
        shape: Shape,
...
extension Tensor {
    ...
    public struct Shape: Equatable, Hashable {
        ...
        var int32Dimensions: [Int32] {
            dimensions.map(Int32.init)
        }
